...
publishFeedContentFromJson(PublishFeedContent data, Map<String, dynamic> json) {
  ...
  if (json['tag'] != null) {
    data.tag = <PublishFeedContentTag>[];
    for (var v in (json['tag'] as List)) {
      data.tag.add(PublishFeedContentTag().fromJson(v));
    }
  }
  if (json['at'] != null) {
    data.at = <PublishFeedContentAt>[];
    for (var v in (json['at'] as List)) {
      data.at.add(PublishFeedContentAt().fromJson(v));
    }
  }
  if (json['attachments'] != null) {
    data.attachments = <PublishFeedContentAttachmants>[];
    for (var v in (json['attachments'] as List)) {
      data.attachments.add(PublishFeedContentAttachmants().fromJson(v));
    }
  }
  if (json['music'] != null) {
...
publishFeedContentAttachmantsFromJson(
    PublishFeedContentAttachmants data, Map<String, dynamic> json) {
  if (json['type'] != null) {
    data.type = json['type'] is String
        ? int.tryParse(json['type'])
        : json['type'].toInt();
...
Map<String, dynamic> publishFeedContentAttachmantsToJson(
    PublishFeedContentAttachmants entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['type'] = entity.type;
  data['url'] = entity.url;
