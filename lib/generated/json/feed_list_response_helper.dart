...
feedListResponseFromJson(FeedListResponse data, Map<String, dynamic> json) {
  if (json['list'] != null) {
    data.xList = <FeedListList>[];
    for (var v in (json['list'] as List)) {
      data.xList.add(FeedListList().fromJson(v));
    }
  }
  if (json['cursor'] != null) {
...
feedListListContentFromJson(
  ...
  if (json['tag'] != null) {
    data.tag = <FeedListListContentTag>[];
    for (var v in (json['tag'] as List)) {
      data.tag.add(FeedListListContentTag().fromJson(v));
    }
  }
  if (json['at'] != null) {
    data.at = <FeedListListContentAt>[];
    for (var v in (json['at'] as List)) {
      data.at.add(FeedListListContentAt().fromJson(v));
    }
  }
  if (json['attachments'] != null) {
    data.attachments = <FeedListListContentAttachmants>[];
    for (var v in (json['attachments'] as List)) {
      data.attachments.add(FeedListListContentAttachmants().fromJson(v));
    }
  }
  if (json['music'] != null) {
...
feedListListContentAttachmantsFromJson(
    FeedListListContentAttachmants data, Map<String, dynamic> json) {
  if (json['type'] != null) {
    data.type = json['type'] is String
        ? int.tryParse(json['type'])
        : json['type'].toInt();
...
Map<String, dynamic> feedListListContentAttachmantsToJson(
    FeedListListContentAttachmants entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['type'] = entity.type;
  data['url'] = entity.url;
