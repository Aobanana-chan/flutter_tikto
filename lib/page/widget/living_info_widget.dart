...
class LivingInfoWidget extends StatefulWidget {
  const LivingInfoWidget({Key key}) : super(key: key);
...
class _LivingInfoWidgetState extends State<LivingInfoWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Positioned(left: 0, child: _getTimeRankLayout()),
          Positioned(right: 0, child: _getChannelLayout()),
          Positioned(right: 20, bottom: 0, child: _getAdLayout())
        ],
      ),
    );
  }
  ...
  _getTimeRankLayout() {
    return Container(
      padding: const EdgeInsets.only(left: 5, right: 6, top: 2, bottom: 2),
