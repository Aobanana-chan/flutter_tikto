...
class VideoCommentWidget extends StatefulWidget {
  ...
  const VideoCommentWidget({Key key, @required this.commentList})
      : super(key: key);
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Text(
                commentModel.commentLikeNumber.toInt().toString(),
          ...
          Row(
            children: [
              Expanded(
                ...
                padding: const EdgeInsets.only(top: 6, bottom: 10, left: 10),
