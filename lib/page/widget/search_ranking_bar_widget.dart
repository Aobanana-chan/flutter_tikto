...
class SearchRankingBarWidget extends StatefulWidget {
  ...
  const SearchRankingBarWidget({Key key, this.onClick}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            InkWell(
              ...
              child: GradientText(
                '抖音热榜',
                gradient: _searchPageController.indexSelectedRank.value == 0
                    ? const LinearGradient(colors: [
                        Color.fromARGB(255, 237, 157, 88),
                        Color.fromARGB(255, 243, 70, 107),
                      ])
                    : const LinearGradient(
                        colors: [ColorRes.color_2, ColorRes.color_2]),
                style: TextStyle(
