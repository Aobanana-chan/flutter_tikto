...
class _ScanPageState extends State<ScanPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _initCamera();
    _animationControllerScan =
        AnimationController(duration: const Duration(seconds: 4), vsync: this);
    _animationScan = Tween<AlignmentGeometry>(
            begin: const Alignment(0.0, -1.2), end: const Alignment(0.0, 1.1))
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
            ...
            top: 0,
            child: Image.asset(
              'assets/images/scan_left_top.webp',
              width: 20,
              height: 20,
            )),
        Positioned(
            ...
            bottom: 0,
            child: Image.asset(
              'assets/images/scan_left_bottom.webp',
              width: 20,
              height: 20,
            )),
        Positioned(
            ...
            bottom: 0,
            child: Image.asset(
              'assets/images/scan_right_bottom.webp',
              width: 20,
              height: 20,
            )),
        Positioned(
            ...
            top: 0,
            child: Image.asset(
              'assets/images/scan_right_top.webp',
              width: 20,
              height: 20,
            )),
        Positioned(
    ...
    return Positioned(
        ...
        child: InkWell(
          ...
          child: Column(
            children: [
              Image.asset(
                'assets/images/tiktok_code.webp',
                width: 60,
                height: 60,
              ),
              const Text(
