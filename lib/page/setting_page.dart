      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ItemTurnWidget(
              img: 'assets/images/active_wallpager.png',
              title: '动态壁纸',
              onClick: () {
                EasyLoading.showToast('功能待开发');
              },
            ...
            ItemTurnWidget(
              img: 'assets/images/setting_common.png',
              title: '通用设置',
              onClick: () {
                EasyLoading.showToast('功能待开发');
              },
            ...
            ItemTurnWidget(
              img: 'assets/images/color_palette.png',
              title: '背景设置',
              onClick: () {
                EasyLoading.showToast('功能待开发');
              },
            ...
            ItemTurnWidget(
              img: 'assets/images/share_app_toutiao.webp',
              title: '头条主页',
              onClick: () {
                EasyLoading.showToast('功能待开发');
              },
            ...
            ItemTurnWidget(
              img: 'assets/images/private_service.png',
              title: '隐私政策',
              onClick: () {
                EasyLoading.showToast('功能待开发');
              },
            ...
            ItemTurnWidget(
              img: 'assets/images/setting_delete.png',
              title: '清理占用空间',
              onClick: () {
                EasyLoading.showToast('功能待开发');
              },
            ...
            ItemTurnWidget(
              img: 'assets/images/setting_exchange.png',
              title: '切换账号',
              onClick: () {
            ...
            ItemTurnWidget(
              img: 'assets/images/setting_logout.png',
              title: '退出登录',
              onClick: () {
                SPUtil.remove(SPKeys.userUid);
                SPUtil.remove(SPKeys.token);
